...
public class AdactinExecutableClass extends AdactionClass1 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		fillTextbox(CheckInDate,"04/04/2021");
		
		WebElement CheckOutDate=driver.findElement(By.id("datepick_in"));
		fillTextbox(CheckOutDate,"05/04/2021");
		...
		fillTextbox(BillingAddress,"No33,gandhi street chitlapakkam,chennai-600064");
		
		WebElement CreditCardNo=driver.findElement(By.id("cc_num"));
		fillTextbox(CreditCardNo,"4538904132109875");
	    ...
	    writeExcel("Adactin","AdactinExcel",0,0,Attribute(OrderNo));
	}
}
